    ...
    // function generatePassword () {
      ...
      //   for (var i = 0; i < alphaNum.length; i++) {
        ...
        //goal: randomly select between 8 to 128 characters from alphaLower and Upper, numbers, and symbols depending on user-specified criteria and print to #generate text area.
        ...
        const passGen = (length, characters) => {
          ...
          //for some reason this function causes an HTML reference error saying writePassword isn't defined. 
          ...
          //This causes conflict if using Option 2 code so am commenting out.
